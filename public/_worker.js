...
function getSecurityHeaders() {
  return {
    'Content-Security-Policy': "default-src 'self'; script-src 'self' 'unsafe-inline' 'unsafe-eval' plausible.io https://utteranc.es; style-src 'self' 'unsafe-inline' fonts.googleapis.com; font-src 'self' fonts.gstatic.com; img-src 'self' data: https:; connect-src 'self' plausible.io https://api.github.com; frame-src 'self' https://utteranc.es https://www.youtube.com https://youtube.com https://embed.acast.com;",
